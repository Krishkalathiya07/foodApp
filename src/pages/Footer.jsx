...
export function FooterTwo() {
  return (
    <footer className="w-full">
      <div className="mx-auto flex flex-col items-start space-y-8 md:flex-row md:space-y-0 md:space-x-8 max-w-6xl">
        <div className="w-full px-4 md:w-1/2 lg:px-0">
          <h1 className="max-w-sm text-3xl font-bold">Subscribe to our Newsletter</h1>
          <form action="" className="mt-4 inline-flex w-full items-center md:w-full">
            <input
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:w-3/4 lg:grid-cols-3 md:mt-0">
